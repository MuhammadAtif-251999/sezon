...
public class GMapDirection {
    ...
    public final static String API = "&key=AIzaSyB7E0P3S5ObRU4dtOqRm4hfqvYXB6t-3Ho";
//    public final static String API = "&key=AIzaSyDEd84qBjXNPZxPAHKT0fRzjBAQPSzDtg8";
    ...
    public String getUrl(LatLng start, LatLng end, String mode, boolean isAlternative) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/json?"
                ...
                + "&sensor=false&units=metric&mode="+mode+API;
