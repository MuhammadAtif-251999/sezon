...
import static io.sezon.sezon.mBox.BoxOrder.INSURANCE;
import static io.sezon.sezon.mBox.BoxOrder.INSURANCE_PRICE;
import static io.sezon.sezon.mBox.BoxOrder.SHIPPER;
import static io.sezon.sezon.mBox.BoxOrder.SHIPPER_PRICE;
import static io.sezon.sezon.mBox.MboxWaiting.DRIVER_LIST;
import static io.sezon.sezon.mBox.MboxWaiting.REQUEST_PARAM;
...
//        mBoxDetailPickup.setText(tanggal+", "+jam+" WIB");
        ...
        if(saldoMpay < (harga*selectedFitur.getBiayaAkhir())){
            mPaySpinner.setEnabled(false);
