...
public class LaundryItem extends AbstractItem<LaundryItem, LaundryItem.ViewHolder> {
    ...
    public LaundryItem(Context context) {
        this.context = context;
    }

    @Override
    public int getType() {
        return R.id.laundry_item_booking;
    }

    @Override
    public void bindView(LaundryItem.ViewHolder holder, List payloads) {
        ...
        //Picasso.with(context).load(fotoLaundry).fit().centerCrop().into(holder.fotoLaundry);
        Glide.with(context)
                .load(fotoLaundry)
