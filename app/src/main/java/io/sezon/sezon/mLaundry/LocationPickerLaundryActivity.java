...
import io.sezon.sezon.mBox.PickLocation;
...
public class LocationPickerLaundryActivity extends AppCompatActivity
...
//            new LatLng(-34.041458,150.790100), new LatLng(-33.682247, 151.383362));
        ...
        autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                InputMethodManager inputManager =
                        (InputMethodManager) LocationPickerLaundryActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void fillAddress(final TextView textView, final LatLng latLng) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Geocoder geocoder = new Geocoder(LocationPickerLaundryActivity.this, Locale.getDefault());
                    final List<Address> addresses = geocoder.getFromLocation(latLng.latitude, latLng.longitude, 1);
                    LocationPickerLaundryActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
