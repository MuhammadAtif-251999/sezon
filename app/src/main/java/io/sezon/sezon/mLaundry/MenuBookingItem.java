...
public class MenuBookingItem extends AbstractItem<MenuBookingItem, MenuBookingItem.ViewHolder> {
    ...
    public MenuBookingItem(Context context, OnCalculatePrice calculatePrice) {
    ...
    @Override
    public void bindView(final MenuBookingItem.ViewHolder holder, List payloads) {
...
//        cost = 1 * harga;
    ...
    public int getLayoutRes() {
        return R.layout.item_list_boking;
    }
