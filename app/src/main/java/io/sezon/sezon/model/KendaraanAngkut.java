...
public class KendaraanAngkut extends RealmObject implements Serializable {
    ...
    @Expose
    @SerializedName("hargaminimum_mbox")
    private long hargaminimummbox;

    public long getBiayaminimum() {
        return hargaminimummbox;
    }
    public void setBiayaminimum(long harga) {
        this.hargaminimummbox = hargaminimummbox;
    }
