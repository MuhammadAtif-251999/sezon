...
public class TicketResultActivity extends AppCompatActivity {
    private static final String TAG1 = TicketResultActivity.class.getSimpleName();
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Log.e(TAG1, "Ticket response: " + response.toString());
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG1, "Error: " + error.getMessage());
                showNoTicket();
            }
        });

        MangJekApplication.getInstance().addToRequestQueue(jsonObjReq);
    }
    ...
    private void renderMovie(JSONObject response) {
        try {
            ...
            Log.e(TAG1, "JSON Exception: " + e.getMessage());
            showNoTicket();
