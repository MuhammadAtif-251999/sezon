package io.sezon.sezon.adapter;
...
import io.sezon.sezon.home.submenu.history.HistoryDetailActivity;
import io.sezon.sezon.mMassage.InProgressFinishedMassageActivity;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        holder.adress1.setText(history.alamat_tujuan);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView status, date, address,adress1;
        ImageView image;
        Context context;
        ...
        public ViewHolder(View view) {
            ...
            this.adress1 = (TextView) view.findViewById(R.id.address1);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(itemHistory.order_fitur.equalsIgnoreCase("Pijat")) {
                        Log.e("LOAD_HISTORY", "Pijat");
