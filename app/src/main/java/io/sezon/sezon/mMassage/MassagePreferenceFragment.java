            ...
            public void onCheckedChanged(RadioGroup radioGroup, int id) {
                switch (id) {
                    ...
                    case R.id.massagePreference_duration120:
                        ...
                        break;
                    case R.id.massagePreference_duration180:
                        preference.setDurasi(2.5);
                        preference.setDurasiText("150 minutes");
                        break;
                    case R.id.massagePreference_duration240:
                        preference.setDurasi(3);
                        preference.setDurasiText("180 minutes");
                        break;
                }
            }
        });
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int id) {
                switch (id) {
                    ...
                    case R.id.massagePreference_therapistNoPrefs:
                        ...
                        preference.setTherapist("Random");
                        break;
                }
            }
        });
