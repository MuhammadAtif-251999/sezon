...
import io.sezon.sezon.adapter.ChatAdapter;
import io.sezon.sezon.adapter.ItemListener;
...
import io.sezon.sezon.utils.AsyncTaskHelper;
...
import static io.sezon.sezon.service.MangJekMessagingService.BROADCAST_ACTION;
...
//        arrChat = initDataDummy();
        ...
        butSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                User user = MangJekApplication.getInstance(getApplicationContext()).getLoginUser();
